FROM ubuntu:bionic
RUN apt-get update && apt-get --no-install-recommends install -y curl git fontconfig apt-utils language-pack-en-base language-pack-zh-hant-base language-pack-zh-hant language-pack-en zsh python3 python3-pip gcc musl-dev telnet wget
